...
[Description("Exports procedures, functions, views and triggers from given server and database")]
public class ExportCommand : Command<ExportCommand.Settings>
{
	...
	{
		Logger.Information($"Exporting objects from database {settings.Server}.{settings.Database}");
